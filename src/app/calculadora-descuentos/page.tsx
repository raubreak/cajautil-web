...
export default function DescuentosApp() {
  ...
  const formatMoney = (n: number) => n.toLocaleString('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col items-center pt-8 pb-16 px-4">
      ...
      <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <section className="bg-white rounded-[40px] shadow-2xl p-8 sm:p-10 border border-slate-100 flex flex-col justify-center space-y-8">
            ...
            <div className="relative group">
                <label className="text-xs font-bold text-slate-400 uppercase tracking-[0.2em] mb-3 block pl-2">Precio Original (€)</label>
            ...
            <button 
                onClick={() => { setPrecioOriginal(''); setDescuento(''); }}
        ...
        {/* Panel Derecho: El Ahorro / Resultado */}
        <section className="bg-slate-900 rounded-[40px] shadow-2xl p-10 flex flex-col justify-between text-white relative overflow-hidden">
                ...
                <div className="space-y-10">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-3xl font-black text-white">-{formatMoney(ahorro)} €</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-6xl font-black text-white leading-none tabular-nums">{formatMoney(precioFinal)} <span className="text-2xl font-bold text-slate-500 block mt-2 sm:inline">€</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="relative z-10 pt-10 mt-10 border-t border-white/10 flex flex-col gap-4">
                <div className="flex items-center justify-between text-sm text-slate-400">
                    ...
                    <span className="font-mono">{formatMoney(original)} €</span>
                </div>
                <div className="flex items-center justify-between text-sm text-emerald-400 font-bold bg-emerald-500/10 p-4 rounded-2xl">
                    ...
                    <span>{formatMoney(ahorro)} € menos</span>
                </div>
            </div>
        </section>
      ...
      <section className="w-full max-w-4xl mt-16 prose prose-slate text-slate-600">
          ...
          <p>Para obtener el precio rebajado de forma manual, simplemente multiplica el precio original por el porcentaje de la rebaja, y luego divide el resultado entre 100 para obtener el ahorro bruto. Finalmente, quítale esa cifra al precio inicial.</p>
          <div className="bg-white border rounded-3xl p-6 shadow-sm flex items-center gap-6">
              ...
              <p className="text-sm font-medium italic">Ejemplo: Una chaqueta de 60€ con un 15% de descuento se calcula como: (60 x 15) / 100 = 9€. Su precio final sería de 51€.</p>
          </div>
          <p className="mt-8">Nuestra herramienta agiliza este proceso para que no cometas errores matemáticos y puedas comparar rápidamente entre varios artículos en tus días de compras más intensos como en Navidad o el Black Friday.</p>
      </section>
