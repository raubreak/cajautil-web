...
import { Landmark, TrendingUp, Calendar, ArrowRight, Wallet, PieChart } from 'lucide-react';
...
export default function CalculadoraPrestamos() {
  ...
  const simulation = useMemo(() => {
    ...
    return {
      ...
      totalInterest,
      rows: rows.slice(0, 12), // Solo mostramos primer año en tabla por UX, resto bajo colapso o aviso
      fullRows: rows,
      nTotal
    };
    ...
    <main className="min-h-screen bg-slate-50 flex flex-col items-center pt-8 pb-16 px-4">
      ...
      <div className="w-full max-w-2xl text-center mb-10">
        ...
        <h1 className="text-4xl font-extrabold text-slate-800 tracking-tight mb-4">
          Simulador de <span className="text-blue-600">Préstamos</span>
        </h1>
      ...
      <section className="w-full max-w-4xl prose prose-slate prose-headings:text-slate-800 mb-16 px-2 text-slate-600">
          ...
          <p>En este simulador utilizamos el **TIN (Tipo de Interés Nominal)** para calcular la cuota bruta. Recuerda que el **TAE (Tasa Anual Equivalente)** es el indicador real del coste, ya que incluye comisiones de apertura, seguros obligatorios y otros gastos adicionales que tu banco podría aplicarte.</p>
